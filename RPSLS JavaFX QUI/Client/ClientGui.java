		...
		this.clientChoice.setOnAction(e->{
			...
			clientConnection = new Client(data ->{//defining consumer interface
				Platform.runLater(()->{
					...
					clientNumberForTitle = clientConnection.gameInfo.client;
					primaryStage.setTitle("This is client " + clientNumberForTitle);
...
//**************************************************** EVENT HANDLER *************************************************
		...
		r.setOnAction(e->{
			...
			if(clientConnection.gameInfo.roundEnd == true){
				primaryStage.setScene(sceneMap.get("clientChatRoomScreen"));
				System.out.println("printing from RockButton, client # = " + gameInfo.client);
				System.out.println("Client " + gameInfo.client + " played " + gameInfo.choice);
				System.out.println("Client " + gameInfo.client + " have2Players = " + gameInfo.have2players);
				System.out.println("Client " + gameInfo.client + " roundNum = " + gameInfo.roundNum);
				System.out.println("Client " + gameInfo.client + " p1RoundNum = " + gameInfo.p1RoundNum);
				System.out.println("Client " + gameInfo.client + " p2RoundNum = " + gameInfo.p2RoundNum);
				//System.out.println("Client " + gameInfo.client + " playAgain = " + gameInfo.playAgain);
				System.out.println("Client " + gameInfo.client + " p1Points = " + gameInfo.p1Points);
				System.out.println("Client " + gameInfo.client + " p2points = " + gameInfo.p2Points);
				System.out.println("Client " + gameInfo.client + " isPlaying = " + gameInfo.isPlaying);
				//System.out.println("Client " + gameInfo.client + " isChallenged = " + gameInfo.isChallenged);
				System.out.println("Client " + gameInfo.client + " newGame = " + gameInfo.newGame);
				System.out.println("Client " + gameInfo.client + " p1Plays = " + gameInfo.p1Plays);
				System.out.println("Client " + gameInfo.client + " p2Plays = " + gameInfo.p2Plays);
				//System.out.println("Client " + gameInfo.client + " opponentPlayed = " + gameInfo.opponentPlayed);
				System.out.println("Client " + gameInfo.client + " roundEnd = " + gameInfo.roundEnd);
			}

			gameInfo.choice = "Rock";
			gameInfo.isThirdSceneMessage = true;
			if(gameInfo.roundEnd = true){
				gameInfo.gameFlag = 0;
				primaryStage.setScene(sceneMap.get("clientWaitScreen"));
